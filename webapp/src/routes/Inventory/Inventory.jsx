                ...
                {colors.map((color) => {
                    return (<div className="selected__line">
                        ...
                        {figures.map(figure => {
                            ...
                            <img src={`./imgs/${showColor === color && showFigure === figure ? selectedStyle : stylesSelected[color][figure]}/${color}/${figure}.svg`} alt={`${color}__${figure}`}/>
                        </label>);
                        })}
                    </div>)
                })}
            ...
            <div className="selector">
                ...
                {stylesAll[showColor][showFigure].map(style => {
                    ...
                    <label className={selectedStyle === style ? 'checked' : ''} key={`style__${style}`} onClick={() => {
                        ...
                        <img src={`./imgs/${style}/${showColor}/${showFigure}.svg`} alt={`${style}`}/>
                    </label>);
                })}
                </div>
            </div>
